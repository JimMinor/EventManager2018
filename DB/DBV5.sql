...
SET DEFINE OFF;
Insert into ADMIN.IMPIEGATO (ID,CODICE_FISCALE,USERNAME,PASSWORD,DATA_ASSUNZIONE,STIPENDIO,EMAIL,TELEFONO,IBAN,ADMIN) values ('43','ABCDEFGHI','admin','admin',to_date('07-09-18','DD-MM-RR'),'0','admin@ticket.it','3331234567',null,'V');
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMIN"."IMPIEGATO" MODIFY ("ADMIN" NOT NULL ENABLE);
