--------------------------------------------------------
--  File creato - sabato-agosto-25-2018   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Sequence EV_ID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "ADMIN"."EV_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence ID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "ADMIN"."ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Table ARTISTA
--------------------------------------------------------

  CREATE TABLE "ADMIN"."ARTISTA" 
   (	"NOME_ARTISTA" VARCHAR2(20 BYTE)
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table ARTISTI_EVENTO_MUSICALE
--------------------------------------------------------

  CREATE TABLE "ADMIN"."ARTISTI_EVENTO_MUSICALE" 
   (	"ID" NUMBER, 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table ATLETA
--------------------------------------------------------

  CREATE TABLE "ADMIN"."ATLETA" 
   (	"NOME_ATLETA" VARCHAR2(20 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table PARTECIPANTI_EVENTO_SPORTIVO
--------------------------------------------------------

  CREATE TABLE "ADMIN"."PARTECIPANTI_EVENTO_SPORTIVO" 
   (	"ID" NUMBER, 
...
;
REM INSERTING into ADMIN.ARTISTA
SET DEFINE OFF;
REM INSERTING into ADMIN.ARTISTI_EVENTO_MUSICALE
SET DEFINE OFF;
REM INSERTING into ADMIN.ATLETA
SET DEFINE OFF;
...
Insert into ADMIN.IMPIEGATO (ID,CODICE_FISCALE,USERNAME,PASSWORD,DATA_ASSUNZIONE,STIPENDIO,EMAIL,TELEFONO) values ('3','NNCVTR93D06M289A','viannaco','03891600',to_date('15-JAN-18','DD-MON-RR'),'600','viot@gmail.com','33358646');
...
REM INSERTING into ADMIN.PARTECIPANTI_EVENTO_SPORTIVO
SET DEFINE OFF;
...
--------------------------------------------------------
--  DDL for Index ARTISTI_EVENTO_MUSICALE_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "ADMIN"."ARTISTI_EVENTO_MUSICALE_PK" ON "ADMIN"."ARTISTI_EVENTO_MUSICALE" ("ID", "ARTISTA") 
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PARTECIPANTI_EVENTO_SPORTI_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "ADMIN"."PARTECIPANTI_EVENTO_SPORTI_PK" ON "ADMIN"."PARTECIPANTI_EVENTO_SPORTIVO" ("ID", "PARTECIPANTE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index ATLETA_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "ADMIN"."ATLETA_PK" ON "ADMIN"."ATLETA" ("NOME_ATLETA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "ADMIN"."ARTISTA_PK" ON "ADMIN"."ARTISTA" ("NOME_ARTISTA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FUNCTION "ADMIN"."INS_EVENTO" (new_nome varchar2, new_luogo varchar2, new_data date, new_prezzo float, new_descrizione varchar2, new_tipologia varchar2)
return NUMBER
IS
new_id number;
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMIN"."ARTISTA" ADD CONSTRAINT "ARTISTA_PK" PRIMARY KEY ("NOME_ARTISTA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "ADMIN"."ARTISTA" MODIFY ("NOME_ARTISTA" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMIN"."ATLETA" ADD CONSTRAINT "ATLETA_PK" PRIMARY KEY ("NOME_ATLETA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "ADMIN"."ATLETA" MODIFY ("NOME_ATLETA" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table PARTECIPANTI_EVENTO_SPORTIVO
--------------------------------------------------------

  ALTER TABLE "ADMIN"."PARTECIPANTI_EVENTO_SPORTIVO" ADD CONSTRAINT "PARTECIPANTI_EVENTO_SPORTI_PK" PRIMARY KEY ("ID", "PARTECIPANTE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "ADMIN"."PARTECIPANTI_EVENTO_SPORTIVO" MODIFY ("PARTECIPANTE" NOT NULL ENABLE);
  ALTER TABLE "ADMIN"."PARTECIPANTI_EVENTO_SPORTIVO" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table ARTISTI_EVENTO_MUSICALE
--------------------------------------------------------

  ALTER TABLE "ADMIN"."ARTISTI_EVENTO_MUSICALE" ADD CONSTRAINT "ARTISTI_EVENTO_MUSICALE_PK" PRIMARY KEY ("ID", "ARTISTA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "ADMIN"."ARTISTI_EVENTO_MUSICALE" MODIFY ("ARTISTA" NOT NULL ENABLE);
  ALTER TABLE "ADMIN"."ARTISTI_EVENTO_MUSICALE" MODIFY ("ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ARTISTI_EVENTO_MUSICALE
--------------------------------------------------------

  ALTER TABLE "ADMIN"."ARTISTI_EVENTO_MUSICALE" ADD CONSTRAINT "ARTISTI_EVENTO_MUSICALE_FK1" FOREIGN KEY ("ID")
	  REFERENCES "ADMIN"."EVENTO" ("ID") ENABLE;
  ALTER TABLE "ADMIN"."ARTISTI_EVENTO_MUSICALE" ADD CONSTRAINT "ARTISTI_EVENTO_MUSICALE_FK2" FOREIGN KEY ("ARTISTA")
	  REFERENCES "ADMIN"."ARTISTA" ("NOME_ARTISTA") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
--  Ref Constraints for Table PARTECIPANTI_EVENTO_SPORTIVO
--------------------------------------------------------

  ALTER TABLE "ADMIN"."PARTECIPANTI_EVENTO_SPORTIVO" ADD CONSTRAINT "PARTECIPANTI_EVENTO_SPORT_FK1" FOREIGN KEY ("ID")
	  REFERENCES "ADMIN"."EVENTO" ("ID") ENABLE;
  ALTER TABLE "ADMIN"."PARTECIPANTI_EVENTO_SPORTIVO" ADD CONSTRAINT "PARTECIPANTI_EVENTO_SPORT_FK2" FOREIGN KEY ("PARTECIPANTE")
	  REFERENCES "ADMIN"."ATLETA" ("NOME_ATLETA") ENABLE;
