--------------------------------------------------------
--  File creato - sabato-settembre-01-2018   
--------------------------------------------------------
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into ADMIN.IMPIEGATO (ID,CODICE_FISCALE,USERNAME,PASSWORD,DATA_ASSUNZIONE,STIPENDIO,EMAIL,TELEFONO) values ('21','DMRSRG70L06F839N','sdimartino','sergione',to_date('15-01-18','DD-MM-RR'),'1800','sergio.dimartino@unina.it',null);
